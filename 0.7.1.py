...
class TheBuster:
    ...
    def ping_stuff(self):
        ...
        with open('alive_hosts.txt', 'w') as alive_list:
            ...
            for i in ip.hosts():
                ...
                if self.IS_WINDOWS:
                    ...
                    toping = subprocess.run(['ping', '-c', '1', i], stdout=PIPE, stderr=PIPE, text=True)
    ...
    def discern(self):
        ...
        txt_records = dns.resolver.resolve('dom.com', 'TXT')
    ...
    def brute_stuff(self):
        ...
        alive_hosts = open('alive_hosts.txt').read().splitlines()
